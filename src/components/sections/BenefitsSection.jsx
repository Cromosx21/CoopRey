	...
	return (
		...
		>
			...
			<div className="absolute inset-0 overflow-hidden">
				...
				/>
				<motion.div
					className="absolute bottom-20 left-0 w-80 h-80 bg-linear-to-br from-emerald-200/20 to-yellow-200/20 rounded-full blur-3xl"
					animate={{
						x: [0, -30, 0],
						y: [0, 50, 0],
						scale: [1, 1.2, 1],
				...
				<div className="grid lg:grid-cols-2 gap-16 items-center">
					...
					>
						<div className="space-y-6">
							<motion.span
								className="inline-block px-4 py-2 bg-secondary/20 text-primary rounded-full text-sm font-medium"
								initial={{ opacity: 0, scale: 0.8 }}
								whileInView={{ opacity: 1, scale: 1 }}
								viewport={{ once: true }}
							>
							...
							<p className="text-xl text-gray-600 leading-relaxed">
								En Cooperativa Niño Rey, no solo ofrecemos
								servicios financieros, te brindamos un
								ecosistema completo de beneficios diseñados para
						...
						<div className="grid sm:grid-cols-2 gap-6">
							{benefits.map((benefit, index) => {
								...
								return (
									...
									>
										<motion.div
											className="shrink-0 w-12 h-12 bg-linear-to-br from-emerald-100 to-yellow-100 rounded-2xl flex items-center justify-center group-hover:from-emerald-500 group-hover:to-yellow-500 transition-all duration-300"
											whileHover={{
												rotate: 10,
												scale: 1.1,
											}}
						...
						<motion.a
							href="#hazte-socio"
							className="inline-flex items-center space-x-2 px-8 py-4 bg-linear-to-r from-emerald-500 to-emerald-600 text-white rounded-full hover:from-emerald-600 hover:to-emerald-700 transition-all duration-300 shadow-xl hover:shadow-2xl"
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
						>
