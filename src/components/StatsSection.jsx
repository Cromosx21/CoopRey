          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                {/* Organic background */}
                <motion.div
                  className={`absolute -inset-4 bg-gradient-to-br ${stat.color} opacity-0 group-hover:opacity-10 rounded-[40%_60%_70%_30%/60%_30%_70%_40%] transition-opacity duration-300 blur-xl`}
                  whileHover={{
                    borderRadius: [
                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 text-center h-full flex flex-col justify-center">
                  {/* Icon */}
                  <motion.div
                    className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${stat.color} rounded-2xl mb-6 shadow-lg mx-auto`}
                  ...
                  >
                    ...
                    <span className="text-3xl font-bold text-gray-900">{stat.suffix}</span>
                  </motion.div>
