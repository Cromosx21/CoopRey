        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              <p>
                La <strong className="text-gray-900">Cooperativa de Ahorro y Crédito Niño Rey</strong> nació en 1999 con el sueño de ofrecer servicios financieros accesibles, justos y orientados al desarrollo de las familias peruanas.
              </p>
              <p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 pt-8">
              {[
                { icon: Target, title: 'Enfoque al socio', description: 'Cada decisión pensada en tu beneficio' },
                { icon: Award, title: 'Excelencia', description: 'Calidad en cada servicio' },
              ].map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-emerald-100 to-yellow-100 rounded-xl flex items-center justify-center">
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">1999</p>
                    <p className="text-xs text-gray-500 mt-1">25+ años de trayectoria</p>
                  </div>
                </div>
              </motion.div>
            </div>
