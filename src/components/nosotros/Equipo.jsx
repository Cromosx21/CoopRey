	...
	return (
		<section className="relative py-32 overflow-hidden bg-linear-to-br from-gray-50 to-emerald-50/30">
			...
			<div className="absolute inset-0 overflow-hidden">
				<motion.div
					className="absolute bottom-0 left-1/4 w-96 h-96 bg-linear-to-br from-emerald-200/20 to-yellow-200/20 rounded-full blur-3xl"
					animate={{
						x: [0, -50, 0],
						y: [0, 50, 0],
						scale: [1, 1.2, 1],
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				>
					<motion.span
						className="inline-block px-4 py-2 bg-secondary/20 text-primary rounded-full text-sm font-medium mb-4"
					...
					<p className="text-xl text-gray-600">
						Un equipo comprometido con la excelencia y el servicio a
						nuestros socios.
					</p>
				</motion.div>
				...
				>
					<div className="max-w-2xl mx-auto bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
						...
						<p className="text-gray-600 mb-6">
							Siempre estamos buscando talento apasionado que
							comparta nuestros valores y visión.
						</p>
						<motion.a
							href="#contacto"
							className="inline-flex items-center px-8 py-3 bg-linear-to-r from-emerald-500 to-emerald-600 text-white rounded-full hover:from-emerald-600 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl font-semibold"
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
						>
