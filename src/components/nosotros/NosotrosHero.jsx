  ...
  return (
    <section className="relative min-h-[70vh] flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute -top-40 right-0 w-[500px] h-[500px] bg-gradient-to-br from-emerald-200/40 to-yellow-200/40 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 50, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-br from-yellow-200/30 to-emerald-200/30 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, -30, 0],
          }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <span className="text-emerald-700 text-sm font-medium">Conoce nuestra historia</span>
          </motion.div>
          ...
          >
            {[
              ...
              return (
                ...
                >
                  <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg mx-auto">
