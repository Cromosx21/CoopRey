      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          >
            ...
            >
              <span className="text-white text-sm font-medium">✨ Únete a la familia Niño Rey</span>
            </motion.div>
            ...
            >
              ...
              <span className="block mt-2">la libertad financiera</span>
            </motion.h2>
            ...
            >
              Hacerse socio es simple, rápido y sin complicaciones. Da el primer paso hoy y descubre todo lo que podemos hacer por ti.
            </motion.p>

            {/* Benefits List */}
            <motion.div
              className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto my-12"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
