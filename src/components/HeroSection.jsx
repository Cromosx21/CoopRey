  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden" id="inicio">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-emerald-200/40 to-yellow-200/40 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 90, 0],
          }}
        ...
        />
        <motion.div
          className="absolute top-1/3 -left-20 w-80 h-80 bg-gradient-to-br from-yellow-200/30 to-emerald-200/30 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            rotate: [0, -90, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-emerald-100/40 to-yellow-100/40 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.1, 1],
          }}
          transition={{
          ...
          >
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-emerald-700 text-sm font-medium">Más de 25 años de confianza</span>
              </motion.div>
            ...
            >
              <motion.a
                href="#hazte-socio"
                className="inline-flex items-center justify-center space-x-2 px-8 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-full hover:from-emerald-600 hover:to-emerald-700 transition-all duration-300 shadow-xl hover:shadow-2xl group"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <span className="font-semibold">Hazte Socio Hoy</span>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                <span className="font-semibold">Conoce Nuestros Servicios</span>
              </motion.a>
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-full aspect-square">
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-emerald-400/20 to-yellow-400/20 rounded-[60%_40%_30%_70%/60%_30%_70%_40%]"
                  animate={{
                    borderRadius: [
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-lg text-gray-900">Hasta 8.5%</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-lg text-gray-900">+15,000</p>
                  </div>
                </div>
              </motion.div>
            </div>
