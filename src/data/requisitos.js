...
export const requisitosCorporativos = [
	{
		...
		items: [
			"Documento de identidad vigente (frente y reverso)",
			"Documento de identidad original para verificación",
			"Fotocopia de pasaporte (si es extranjero)",
			"Recibo de agua o luz (últimos 3 meses)",
		],
	},
	{
		id: 2,
		...
		items: [
			"Último recibo de boletas de pago",
			"Documento de contrato laboral",
	...
	},
	{
		...
		items: [
			...
			"Cuaderno o registro de ingresos",
